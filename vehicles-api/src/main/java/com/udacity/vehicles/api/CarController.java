...
public class CarController {
    ...
    public CarController(CarService carService, CarResourceAssembler carResourceAssembler) {
    ...
    public Resources<Resource<Car>> list() {
        List<Resource<Car>> resources =
                this.carService.list().stream().map(this.carResourceAssembler::toResource).collect(Collectors.toList());
    ...
    public Resource<Car> get(@PathVariable Long id) {
         ...
         */
        return this.carResourceAssembler.toResource(this.carService.findById(id));
    }
    ...
    public ResponseEntity<?> post(@Valid @RequestBody Car car) throws URISyntaxException {
         ...
         *       Update the first line as part of the above implementing.
         */
        Resource<Car> resource = this.carResourceAssembler.toResource(this.carService.save(car));
